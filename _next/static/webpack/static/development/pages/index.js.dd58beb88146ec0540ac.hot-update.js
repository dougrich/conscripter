    ...
    value: function createCommand(cmd, i, arr) {
      ...
      if (cmd.code === 'C') {
        ...
        var _cmd = cmd,
            ...
            x2 = _cmd.x2,
            _y2 = _cmd.y1,
            y2 = _cmd.y2; // interpolate - note we skip the start as it should be drawn from the previous node
...
//# sourceMappingURL=index.js.dd58beb88146ec0540ac.hot-update.js.map